...
#+BEGIN_SRC emacs-lisp
  ...
  (setq mu4e-maildir (expand-file-name "~/Maildir/acc1-gmail"))

  (setq mu4e-drafts-folder "/[acc1].drafts")
  (setq mu4e-sent-folder   "/[acc1].Sent Mail")
  (setq mu4e-trash-folder  "/[acc1].Trash")
